INSERT INTO `vodafoneziggo`.`user` (`idUser`, `email`, `firstName`, `password`, `lastName`) VALUES ('1557216', 'anneliebonnet@live.nl', 'Annelie', 'Lunkarya', 'Bonnet');
INSERT INTO `vodafoneziggo`.`user` (`idUser`, `email`, `firstName`, `password`, `lastName`) VALUES ('1544216', 'info@liaaarsbergen.nl', 'Lia ', '2E2721KN', 'Aarsbergen');
INSERT INTO `vodafoneziggo`.`user` (`idUser`, `email`, `firstName`, `password`, `lastName`) VALUES ('2335216', 'Aba.ruyter@worldonline.nl', 'Karina ', 'Aba33dbe', 'Aba');
INSERT INTO `vodafoneziggo`.`user` (`idUser`, `email`, `firstName`, `password`, `lastName`) VALUES ('2335214', 'Jos.anema@planet.nl', 'Josephine ', 'sweex291', 'Anema');
...
INSERT INTO `vodafoneziggo`.`category` (`id`, `firstName`) VALUES ('1', 'geen internet');
INSERT INTO `vodafoneziggo`.`category` (`id`, `firstName`) VALUES ('2', 'traag wifi');
INSERT INTO `vodafoneziggo`.`category` (`id`, `firstName`) VALUES ('3', 'geen wifi');

INSERT INTO `vodafoneziggo`.`questionnaire` (`id`, `created`, `category`) VALUES ('1', '2019-06-2 09:00:00', '1');
INSERT INTO `vodafoneziggo`.`questionnaire` (`id`, `created`, `category`) VALUES ('2', '2019-06-2 09:00:00', '2');
INSERT INTO `vodafoneziggo`.`questionnaire` (`id`, `created`, `category`) VALUES ('3', '2019-06-2 09:00:00', '3');
