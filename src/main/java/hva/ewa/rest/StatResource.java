...
public class StatResource {
    ...
    public StatResource() {
        chatRepositoryService = ChatRepositoryServiceImpl.getInstance();
    ...
    public Response getStatistics() {
        ...
        Map<String, Long> chats = chatRepositoryService.getAmountOfChatsByMonth();
        try {
            obj.put("satisfaction", chatRepositoryService.getCustomerSatisfaction());
            obj.put("totalChats", chatRepositoryService.getAmountOfChats());
